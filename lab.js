...
//Code here
favoriteThings.car = 'Ford Focus'
favoriteThings.show = 'AHS'
...
const {texas, utah, caliifonia, arizona} = state  
return texas + utah + caliifonia + arizona 
}
...
function ingredients = (obj) => {
  ...
  anArray.push(carbs, fat, protein)
  return anArray
}
// console.log(ingredients(healthy))
...
class Cat {
  ...
  mean(){
    console.log(` i am ${this.name} and i am an ${this.age} year old ${this.color} cat.`)
  }
}
let sassy = new Cat ('sassy', '24', 'orange');
...
let harry = new Wizard ('Harry', 6, 'Boo')
// harry.castSpell()
...
class Phone{
  ...
  sell(){
    this.sold = true
    console.log(` ${this.model} has been sold`);
  }
...
let iphone = new Phone ('iphone', '5', 10, 'red', 100)
let nokia = new Phone ('nokia', '1', 15, 'blue', 150)
let blackberry = new Phone ('blackberry', '7', 25, 'white', 200)
//Code Here
